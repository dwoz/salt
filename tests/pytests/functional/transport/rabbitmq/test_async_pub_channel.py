...
class Collector(salt.utils.process.SignalHandlingProcess):
    ...
    def __init__(self, minion_config, pub_uri, aes_key, timeout=30):
        ...
        self._rmq_nonblocking_connection_wrapper = None
    ...
    def run(self):
        ...
        self._rmq_nonblocking_connection_wrapper = (
            rabbitmq.RMQNonBlockingConnectionWrapper(
                self.minion_config,
                io_loop=io_loop,
        ...
        self._rmq_nonblocking_connection_wrapper.connect(message_callback=callback)
        io_loop.start()
...
class PubServerChannelProcess(salt.utils.process.SignalHandlingProcess):
    ...
    def run(self):
        ...
        pub_server_channel = rabbitmq.RabbitMQPublishServer(self.master_config)
